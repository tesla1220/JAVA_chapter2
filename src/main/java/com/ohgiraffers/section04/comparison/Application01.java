...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   '>=' : 왼쪽의 피연산자가 오른쪽의 피연산자 보다 크거나 같으면 true 아니면 flase를 반환
        *   '<' : 왼쪽의 피연산자가 오른쪽의 피연산자 작으면 true 아니면 false를 반환
        ...
        * */
        ...
        System.out.println("inum1과 inum2가 같지 않은 지 비교 :" + (inum1 != inum2));
        // 구분선
        ...
        System.out.println("===========ch1가 ch2보다 큰 지 비교 : " + (ch1 > ch2));
        System.out.println("===========ch1가 ch2보다 크거나 같은 지 비교 : " + (ch1 >= ch2));
        System.out.println("===========ch1가 ch2보다 작은 지 비교 : " + (ch1 < ch2));
        System.out.println("===========ch1가 ch2보다 작거나 같은 지 비교 : " + (ch1 <= ch2));
        ...
        System.out.println("bool1과 bool2가 같은 지 비교 : " + (bool1 != bool2));
        System.out.println("====================================================");
//        System.out.println("bool1이 bool2보다 같은 지 비교 : " + (bool1 > bool2));
//        System.out.println("bool1이 bool2보다 크거나 같은 지 비교 : " + (bool1 >= bool2));
//        System.out.println("bool1이 bool2보다 작거나 같은 지 비교 : " + (bool1 <= bool2));
//        System.out.println("bool1이 bool2보다 작은 지 비교 : " + (bool1 < bool2));
        ...
        System.out.println("str1과 str2가 같은 지 비교 : " + (str1 == str2));
        System.out.println("str1과 str2가 다른 지 비교 : " + (str1 != str2));
        System.out.println("=======================================================");
//        System.out.println("str1이 str2가 보다 큰 지 비교 : " + (str1 > str2));
//        System.out.println("str1이 str2보다 크거나 같은 지 비교 : " + (str1 >= str2));
//        System.out.println("str1이 str2가 작은 지 비교 : " + (str1 < str2));
//        System.out.println("str1이 str2보다 작거나 같은 지 비교 : " + (str1 <= str2));
//
