...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 필기.
        *   조건식 두 개가 모두 만족해야 true를 반환하지만,
        *   앞에서 미리 false가 나오면 뒤의 조건을 확인할 필요가 없이 false를 반환한다.
        *   따라서 연산 횟수를 줄이기 위해서는 && 연산의 경우 앞에 false가 나올 가능성이 높은 편을 작성하는 것이 좋다.
        * */
        ...
        /* 필기.
        *   조건식 둘 중 하나라도 true 를 반환하면 true를 반환하기 때문에
        *   앞에서 미리 true가 나오기 되면 뒤의 조건을 확인할 필요없이 true를 반환한다.
       ...
       int result2 = (true || ++num2 > 0)? num2 : num2;
        ...
        int result = (false || ++num2 > 0)? num2 : num2;
        System.out.println( " || 실행 확인 : " + result2);
